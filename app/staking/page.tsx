...
// Empty data - to be populated from blockchain
const DUMMY_DATA = {
  totalStaked: 0,
  circulatingSupply: 0,
  ...
  userRewards: 0,
  stakingAPR: 0,
  epochRewards: [] as { epoch: number; reward: number; timestamp: string }[],
};
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-zinc-500">Available: <span className="text-[#00FFE0]">0</span> HYDRO</span>
                </div>
            ...
            <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[#141414] border border-[#1f1f1f] rounded-lg p-4">
                  ...
                  <p className="text-xl font-bold text-white">{DUMMY_DATA.userRewards}</p>
                  <p className="text-xs text-[#00FFE0]">HYDRO</p>
                </div>
                <div className="bg-[#141414] border border-[#1f1f1f] rounded-lg p-4">
            ...
            <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xl font-bold text-[#00FFE0]">{DUMMY_DATA.userRewards} HYDRO</p>
                </div>
              </div>

              {/* Bar Chart */}
              <div className="flex items-end justify-between gap-2 h-32 mb-4">
                {DUMMY_DATA.epochRewards.map((epoch, index) => (
                  <div key={epoch.epoch} className="flex-1 flex flex-col items-center gap-2">
                    <div className="text-xs text-zinc-500">{epoch.reward.toFixed(1)}</div>
                    <div
                      className="w-full bg-gradient-to-t from-[#00FFE0] to-[#00FFE0]/30 rounded-t-md transition-all hover:from-[#00FFE0] hover:to-[#00FFE0]/50"
                      style={{ height: `${(epoch.reward / maxReward) * 100}%` }}
                    />
                    <div className="text-xs text-zinc-500">{epoch.timestamp}</div>
                  </div>
                ))}
              </div>

              {/* Claim Button */}
              <button className="w-full py-3 bg-[#141414] border border-[#00FFE0]/30 text-[#00FFE0] font-semibold rounded-lg hover:bg-[#00FFE0]/10 transition-colors">
                Claim {DUMMY_DATA.userRewards} HYDRO Rewards
              </button>
            </div>
          </div>
        </div>
