...
var highestTag = Object.values(UPLCBuiltinTag).reduce(function(max, tag) {
    return isNonNegativeInt(tag) ? tag > max ? tag : max : max;
}, 0);
...
function builtinTagFromString(tag) {
    switch(tag.trim()){
        ...
        case "andByteString":
            return UPLCBuiltinTag.andByteString;
        case "orByteString":
            return UPLCBuiltinTag.orByteString;
        case "xorByteString":
            return UPLCBuiltinTag.xorByteString;
        case "complementByteString":
            return UPLCBuiltinTag.complementByteString;
        case "readBit":
            return UPLCBuiltinTag.readBit;
        case "writeBits":
            return UPLCBuiltinTag.writeBits;
        case "replicateByte":
            return UPLCBuiltinTag.replicateByte;
        case "shiftByteString":
            return UPLCBuiltinTag.shiftByteString;
        case "rotateByteString":
            return UPLCBuiltinTag.rotateByteString;
        case "countSetBits":
            return UPLCBuiltinTag.countSetBits;
        case "findFirstSetBit":
            return UPLCBuiltinTag.findFirstSetBit;
        case "ripemd_160":
            return UPLCBuiltinTag.ripemd_160;
        default:
            // tag; // check that is of type 'never'
...
var Builtin = function() {
    ...
    Object.defineProperty(Builtin, "andByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.andByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "orByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.orByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "xorByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.xorByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "complementByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.complementByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "readBit", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.readBit);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "writeBits", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.writeBits);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "replicateByte", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.replicateByte);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "shiftByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.shiftByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "rotateByteString", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.rotateByteString);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "countSetBits", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.countSetBits);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "findFirstSetBit", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.findFirstSetBit);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Builtin, "ripemd_160", {
        get: function() {
            return new Builtin(UPLCBuiltinTag_1.UPLCBuiltinTag.ripemd_160);
        },
        enumerable: false,
        configurable: true
    });
...
function prettyUPLC(term, _indent) {
    ...
    function _prettyUPLC(t, dbn, depth) {
        ...
        if (t instanceof Constr_1.Constr) {
            if (t.terms.length === 0) return indent + "(constr " + t.index.toString() + ")";
            var nextIndent = indent + indentStr;
            return indent + "(constr " + t.index.toString() + nextIndent + "[" + t.terms.map(function(term) {
                return _prettyUPLC(term, dbn, depth + 2);
            }).join(",\n") + nextIndent + "]" + indent + ")";
        }
        if (t instanceof Case_1.Case) {
            var nextIndent = indent + indentStr;
            return indent + "(case" + _prettyUPLC(t.constrTerm, dbn, depth + 1) + nextIndent + "[" + t.continuations.map(function(term) {
                return _prettyUPLC(term, dbn, depth + 2);
            }).join(",\n") + nextIndent + "]\n" + indent + ")";
        }
        return "";
...
var UPLCEncoder = function() {
    function UPLCEncoder(options) {
        if (options === void 0) {
            options = exports.defaultUPLCEncoderOptions;
        }
    ...
    UPLCEncoder.prototype.encodeApplicationTerm = function(app) {
        ...
        if (this._options.trivialOptimization === true && this._ctx.is_v3_friendly) {
            var args = [];
            var term = app;
    ...
    UPLCEncoder.prototype.encodeForceTerm = function(force) {
        if (this._options.trivialOptimization === true && force.termToForce instanceof Delay_1.Delay) {
